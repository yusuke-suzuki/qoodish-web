    ...
    return (
      <Html>
        <Head>
          ...
          {/* biome-ignore lint/suspicious/noExplicitAny: Required for Emotion + Next.js SSR to inject styles. */}
...
CustomDocument.getInitialProps = async (ctx) => {
  ...
  ctx.renderPage = () =>
    originalRenderPage({
      ...
      enhanceApp: (App: React.ComponentType<React.ComponentProps<any>>) =>
  ...
  const emotionStyleTags = emotionStyles.styles.map((style) => (
    <style
      ...
      key={style.key}
      // biome-ignore lint/security/noDangerouslySetInnerHtml: Required for Emotion + Next.js SSR. The CSS is generated by Emotion and is considered safe.
