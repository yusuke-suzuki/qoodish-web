...
1. These Terms apply to all relationships between us and users concerning use of the Service.
2. Any individual provisions, guidelines, or other rules that we separately establish on the Service (the "Individual Provisions") form a part of these Terms. Where the provisions of these Terms differ from those of the Individual Provisions, the Individual Provisions shall prevail.
...
- "Map" means a collection of information about places that a user creates on the Service.
- "Report" means an image, comment, or other information about a place that a user posts to the Service.
- "Posted Content" means any information, including Reports, that a user posts or transmits to the Service.

## Article 3 (Registration)

1. Registration for the Service is completed when a user performs authentication by the method we designate and we approve it. The Service provides authentication via a Google account through Google Cloud Identity Platform, or authentication by sending a link to an email address.
2. We may decline to approve a registration where we determine that the applicant falls under any of the following, and we bear no obligation to disclose the reason.
...
1. Users shall manage and keep the account used for authentication of the Service at their own responsibility, and shall not allow a third party to use it or lend, transfer, change the name of, or otherwise allow a third party to use it.
2. We bear no liability for any damage caused to a user or a third party due to insufficient management of the account used for authentication, errors in its use, use by a third party, or the like.
3. Where a user uses the Service through a Google account or another external service account, the user shall comply with the terms established by that external service regarding its use, and we bear no liability for any damage arising from use of that external service.

## Article 5 (Posted Content and Copyright)

1. Users represent and warrant to us that they have the proper right to post the Posted Content and that the Posted Content does not infringe the rights of any third party.
2. The copyright in Posted Content is retained by the user or other rights holder who created the Posted Content.
3. At the time a user posts Posted Content to the Service, the user grants us, free of charge, a license to use the Posted Content in Japan and abroad (including reproduction, public transmission, distribution, translation, adaptation, display, and modification such as resizing and cropping) to the extent necessary to provide, maintain, improve, and promote the Service.
4. In using Posted Content under the preceding paragraph, we will endeavor not to unfairly harm the honor or reputation of users. If a user considers that their honor or reputation has been harmed, please contact us.
5. We bear no obligation to pay any consideration to users for the use of Posted Content.
...
- Acts of using information obtained through the Service for commercial purposes without our permission
- Acts for the purpose of sales, advertising, solicitation, or other profit-making, without our permission
- Acts of using the Service for the purpose of meeting persons of the opposite sex whom one has not met, or for any other purpose differing from the original purpose of the Service
...
- Acts of transmitting or posting harmful computer programs or the like
...
1. We may suspend or interrupt all or part of the Service without prior notice to users where any of the following applies.
   - Where maintenance, inspection, or updating of the systems for the Service is carried out
   - Where provision of the Service becomes difficult due to force majeure such as an earthquake, lightning, fire, power outage, or natural disaster
   - Where computers or communication lines stop due to an accident
   - Where we otherwise determine that provision of the Service is difficult
2. We bear no liability for any damage suffered by a user or a third party as a result of suspension or interruption of the Service.

## Article 8 (Restriction of Use and Cancellation of Registration)

1. We may, without prior notice, restrict use of the Service, delete Posted Content, cancel registration, or take other measures we determine to be necessary with respect to a user, where the user falls under any of the following.
   - Where the user has violated any provision of these Terms
   - Where it becomes clear that there is a false fact in the registration details
...
3. When we accept a report, we will notify the reporter of its receipt, examine the Posted Content against these Terms and applicable laws, and, as a rule within 7 days of receipt, decide whether to remove the Posted Content or take other measures and notify the reporter of the outcome. Where a decision requires more time, we may extend the period after notifying the reporter.
4. When we remove Posted Content or take other measures, we will notify the user who posted it of the measure and the reason. This does not apply where notice is prohibited by law or where notice would impair the safe operation of the Service.
5. A user subject to a measure may object through the contact set out in Article 18. We will examine the objection and reconsider the measure where we find it necessary.
6. We retain records of reports and of the measures taken on them, as a history of our handling, for the period required by law or necessary for the safe operation of the Service.
...
3. The map information displayed on the Service is provided by Google LLC, and use of that map information is subject to the terms of service and privacy policy established by Google LLC.
