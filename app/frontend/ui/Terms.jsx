      ...
      <div>
        ...
        >
          ...
          <Typography component="p" gutterBottom>
            ...
            の利用について、以下のように定めます。(以下、本規約といいます)。
            Qoodish の利用者 (以下、お客さまといいます)
          ...
          <Typography component="p" gutterBottom>
            Qoodish は、ソーシャルネットワーキングサービス (以下、SNS
            といいます)
            ...
            また、お客さまは Qoodish へのログイン時に使用するアカウントの提供元
            SNS
          ...
          <Typography component="p" gutterBottom>
            ...
            <br />
            (7) 当委員会は Qoodish ユーザーのレポートを利用したことによって
            Qoodish
          ...
          <Typography component="p" gutterBottom>
            ...
            ユーザーが作成したレポートの投稿を含みます)、Qoodish ユーザーは各
            SNS の運営者が規定する各規約の定めに従うものとします。
            <br />
          ...
          <Typography component="p" gutterBottom>
            (1)
            お客さまがQoodishを利用するにあたって、次の行為を行うことを禁止します。
            ...
            <br />
            7. Qoodish
            の運営を妨げるような行為、または当委員会の信用を毀損する行為
            <br />
            ...
            (一時的な使用を含む)
            <br />
            10. 面識のない異性との出会い等を目的として Qoodish
            の機能を利用すること
            <br />
