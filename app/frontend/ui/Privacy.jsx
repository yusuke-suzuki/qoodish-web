      ...
      <div>
        ...
        <div style={this.props.large ? styles.containerLarge : styles.containerSmall}>
          ...
          <Typography
            ...
            gutterBottom
          >
            Qoodish 製作委員会 (以下「当委員会」といいます) は、提供するサービス「Qoodish」(以下「Qoodish」といいます) を利用される方 (以下「Qoodish ユーザー」といいます) のプライバシーを尊重するために、Qoodish ユーザーの個人情報を以下の定義に従い、適切に管理するよう取り組みを行って参ります。
          </Typography>
          <br/>
          <Typography
            type='display1'
          ...
          <Typography
            ...
            gutterBottom
          >
            個人情報とは、Qoodish を通じて Qoodish ユーザーから取得する氏名・メールアドレス・ログイン時に利用する SNS アカウントのデータ他、個人を特定できる情報のことを指します。
            本項で定める個人情報は、Qoodish ユーザーが初回を含む毎回のログイン時にその都度サービス提供に必要なもののみに限定して収集いたします。
          </Typography>
          <br/>
          <Typography
            type='display1'
          ...
          <Typography
            ...
            gutterBottom
          >
            当委員会は、以下に定める場合を除き、事前に Qoodish ユーザー本人の同意を得ず、本来の利用目的を逸脱した形での個人情報利用を行うことはありません。
            <br/>
            ・法令によって認められた場合
            <br/>
            ・Qoodishユーザの皆様ご自身の了承があった場合
            <br/>
            ・人の生命や身体、または財産の保護のために必要で、事前に Qoodish ユーザー本人の同意を得ることが難しい場合
            <br/>
            ・裁判所や検察庁、警察、税務署、弁護士会またはこれらに準ずる権限を持つ機関より、個人情報開示を求められた場合
            <br/>
            ・Qoodish のサービス提供のために当委員会が必要と判断した際に弁護士など、当委員会に対して秘密保持義務を負うものに対して開示する場合
            <br/>
          ...
          <Typography
            ...
            gutterBottom
          >
            Qoodish を通してアクセスが可能な第三者のサイト及びサービスにおいて収集されうる個人情報の利用については、当委員会では関知しておりません。
          ...
          >
            ...
            ただ、請求元が Qoodish ユーザーご本人であると確認ができない場合や、法令の定めている要件を満たさない場合には、ご希望に添えないこともございます。予めご了承ください。
          ...
          >
            ...
            その際は最新のプライバシーポリシーを本ページに掲載したうえで、Qoodish ユーザーの皆様に対して通知をさせていただきます。
