...
import ReviewLikeActions from '../ui/ReviewLikeActions';
...
const mapDispatchToProps = (dispatch, ownProps) => {
  return {
    ...
    handleSendCommentButtonClick: async () => {
    }
  };
};

export default React.memo(connect(mapStateToProps, mapDispatchToProps)(ReviewLikeActions));
